                ...
                <div className="container">
                    ...
                    <div className="row align-items-center text-center py-sm-5">
                        ...
                        <div className="col-lg-8 mx-auto">
                            ...
                            <figure className="m-0 pt-5 pt-md-0">
                                <svg className="col-sm-7 col-lg-5" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1285.3 712.4" style={{enableBackground: 'new 0 0 1285.3 712.4'}} xmlSpace="preserve">
                  ...
                  C1041.5,672.8,1103.1,678.7,1103.1,685.3z" />
                    ...
                    c45.9-18.5,88.6-32.6,105.1-32.4c2.5,0,4.3,0.4,5.5,1.1C755,486.3,767.7,565.1,761,619z" />
                            ...
                            {/* Button */}
                            <a className="btn btn-primary-soft btn-sm" href="index-2.html">Got to home page</a>
                        </div>
                        {/* Error 404 START */}
                    </div>
                    {/* Extra space */}
