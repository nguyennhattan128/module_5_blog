                        ...
                        <li className="nav-item ms-2 dropdown">
                            ...
                            <ul className="dropdown-menu dropdown-animation dropdown-menu-end pt-3 small me-md-n3" aria-labelledby="profileDropdown">
                                ...
                                <li className="px-3">
                                    ...
                                    <a className="dropdown-item btn btn-primary-soft btn-sm my-2 text-center" href="">View profile</a>
                                </li>
                                <li><a className="dropdown-item" href=""><i className="bi bi-gear fa-fw me-2" />Settings &amp; Privacy</a></li>
                                <li>
