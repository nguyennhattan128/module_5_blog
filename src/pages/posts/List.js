                                    ...
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <div className="dropdown">
                                            ...
                                            <ul className="dropdown-menu dropdown-menu-end"
                                                ...
                                                <li><a className="dropdown-item"> <i className="bi bi-x-circle fa-fw pe-2"/>Delete</a>
                                                </li>
                                    ...
                                    <ul className="nav nav-stack py-3 small">
                                        <li className="nav-item">
                                            <a className="nav-link active" href="my-blog/src/components#!"> <i
                                                className="bi bi-hand-thumbs-up-fill pe-1"/>Liked ({item.like.length})</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" href="my-blog/src/components#!"> <i
                                                className="bi bi-chat-fill pe-1"/>Comments ({item.comments.length})</a>
                                        </li>
                                    ...
                                    <textarea className="form-control pe-4 fs-3 lh-1 border-0" rows={2}
                                              placeholder="Share your thoughts..." defaultValue={""}/>
                                                ...
                                                <div className="modal-footer ">
                                                    <button type="button" className="btn btn-success-soft">Post now
                                                    </button>
                                                </div>
                                            </Form>
                                        </Formik>
